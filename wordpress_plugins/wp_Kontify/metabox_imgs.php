			...
			<div id="field1zzx-container" class="field f_100">
				<div class="option clearfix">
					...
					<div id="wp_automatic_featured_list_opt" class="field f_100">
						...
						<!-- Caption options -->
						<div class="option clearfix">
							<input data-controls="optthumbcaption" name="camp_options[]" value="OPT_THUMB_CAPTION" type="checkbox"> <span class="option-title"> Set the image caption from original caption if exists </span>

							<div id="optthumbcaption">

								 	<div>
										<input name="camp_options[]" value="OPT_THUMB_CAPTION2" type="checkbox"> <span class="option-title"> If no caption exists at the source, Set the caption to the post title </span>
									</div>
