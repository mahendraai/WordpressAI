	...
	<div class="TTWForm">
               ...
               <div class="option clearfix">
		            ...
		            <div id="default_slug" class="field f_100">
					   ...
					   <input value="<?php   echo @$camp_general['cg_custom_slug']  ?>" name="cg_custom_slug"    type="text">
		          		...
		          		<div class="description">For example, [original_title] TEST<br><br>Example2: [post_title] TEST <-- uses the final post title<br><br>Example3: [gpt]Translate to English:[post_title][/gpt]</div>	
		...
		<div  class="field f_100">
               <div class="option clearfix">
		            ...
		            <div class="description">for example add "item_price|item_price * 1.5" so if the tag named [item_price] will return 10, it will return 15 instead.<br><br>*for example add "item_price|item_price + 2" so if the tag named [item_price] will return 10, it will return 12 instead.<br><br>*If posting from amazon, use this config: <br>product_list_price| product_list_price + 2
<br>product_price| product_price + 2
<br>price_numeric|price_numeric +2
<br>list_price_numeric|list_price_numeric +2</div>	 
