jQuery(document).ready(function () {
  ...
  function supportedUpdate() {
    if (typeof supportedTags != "undefined") {
      ...
      supportedText =
        supportedText +
        ',<abbr title="The final post title that the plugin will insert to the database, Do not use in the post title template field" >[post_title]</abbr>, <abbr title="Retruns the title words as hashtags. e.g: if the title is hello world, it will return #hello #world" >[title_words_as_hashtags]</abbr>,  <abbr title="Return the current timestamp" >[now]</abbr>' + ', <abbr title="Retruns the title words as slug. e.g: if the title is hello world, it will return hello-world" >[title_words_as_slug]</abbr>' ;


      // fixed tags for all campaigns content only add to the tags metabox
      jQuery("#supported_tags").append(
        "<li><strong>[post_title]</strong>: The final post title that the plugin will insert to the database, Do not use in the post title template field</li><li><strong>[title_words_as_hashtags]</strong>: Returns the title words as hashtags. e.g: if the title is hello world, it will return #hello #world</li><li><strong>[now]</strong>: Return the current timestamp</li><li><strong>[title_words_as_slug]</strong>: Returns the title words as slug. e.g: if the title is hello world, it will return hello-world</li>"
      );
