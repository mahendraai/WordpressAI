				...
				<div class="metabox-holder columns-2 " id="dashboard-widgets">
					...
					<div class="postbox-container wp_automatic_hide_noactive">
						<div style="min-height: 1px;" class="meta-box-sortables ui-sortable" id="normal-sortables">
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								<h2 class="hndle">
									<img class="wp_automatic_box_icon" src="<?php   echo plugins_url('images/tw.png',__FILE__)?>"><span> x.com settings</span>
								</h2>
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									<!--start container-->

									<div class="field f_100 ">
										<label>Access Token</label> <input value="<?php   echo get_option( 'wp_automatic_x_token' ) ?>" name="wp_automatic_x_token" type="text">
										<div class="description">
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside main TTWForm" style="padding-bottom: 14px">
									...
									<div id="field11-container" class="field f_100">
										...
										<!-- checkbox Rotate proxies to use a new proxy every run -->
										<div class="option clearfix">
											<input name="wp_automatic_options[]" <?php   echo cchecked('wp_automatic_options', 'OPT_ROTATE_PROXY')  ?> value="OPT_ROTATE_PROXY" type="checkbox"> <span class="option-title"> Rotate proxies to use a new proxy every run</span>
										</div>

										<!-- checkbox force use these proxies on all campaigns -->
										<div class="option clearfix">
											<input name="wp_automatic_options[]" <?php   echo cchecked('wp_automatic_options', 'OPT_FORCE_PROXY')  ?> value="OPT_FORCE_PROXY" type="checkbox"> <span class="option-title"> Force use these proxies on all campaigns</span>
										</div>
